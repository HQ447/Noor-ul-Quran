  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt=""
        className="w-full object-cover h-full absolute top-0 left-0 -z-20"
      />

      <div className="flex flex-wrap px-8 gap-11 -xsm:gap-3 justify-center -xsm:px-3 ">
        <div className=" bg-[#ffffffb0] text-black  shadow-md border  p-5 -xsm:p-2 rounded-md">
          <div className="  h-48 w-40 -xsm:h-32 -xsm:w-28">
            <img
          ...
          <p className="text-sm my-2 w-full text-center ">Holy Quran</p>
          <a href={quran}>
        ...
        <div className="bg-[#ffffffb0] text-black shadow-md border  p-5 -xsm:p-2 rounded-md ">
          ...
          <p className="text-sm my-2 w-full text-center ">Noorani Qaida</p>
          <a href={qaida}>
        ...
        <div className="bg-[#ffffffb0] text-black shadow-md border p-5 -xsm:p-2 rounded-md">
          ...
          <p className="text-sm my-2 w-full text-center ">Lughat ul Muslim</p>
          <a href={book}>
