    ...
    <div className="min-h-screen p-4 bg-gradient-to-br from-emerald-50 to-teal-50 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 overflow-hidden bg-white shadow-xl rounded-2xl">
          <div className="px-8 py-6 bg-gradient-to-r from-emerald-600 to-teal-600">
            <div className="flex flex-col items-center gap-6 md:flex-row">
              <div className="relative">
                <img
                  src={teacher?.img || "/api/placeholder/150/150"}
                  alt={teacher?.name}
                ...
                />
                <div
                  className={`absolute -bottom-2 -right-2 px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1 ${getStatusColor(
                    teacher?.status
                  )}`}
                >
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="mb-1 text-lg text-emerald-100">
                  {teacher?.designation}
                </p>
          ...
          {teacher?.bio && (
            <div className="px-8 py-6 border-b border-gray-200">
              ...
              <p className="leading-relaxed text-gray-600">{teacher.bio}</p>
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col justify-center gap-4 mt-8 sm:flex-row">
          <button className="px-8 py-3 font-medium text-white transition-colors rounded-lg shadow-lg bg-emerald-600 hover:bg-emerald-700">
            Contact Teacher
          </button>
          <button className="px-8 py-3 font-medium transition-colors bg-white border rounded-lg shadow-lg hover:bg-gray-50 text-emerald-600 border-emerald-600">
            View Classes
          </button>
        </div>
      </div>
