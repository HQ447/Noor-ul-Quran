    ...
    <section className="py-16 bg-gradient-to-br from-emerald-50 via-white to-blue-50">
      ...
      <div className="relative max-w-6xl px-6 mx-auto lg:px-12">
        ...
        <div className="mb-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-4 text-sm font-semibold rounded-full bg-emerald-100 text-emerald-800">
            <Star className="w-4 h-4" />
            Student Testimonials
          </div>
          <h2 className="mb-2 text-2xl lg:text-3xl font-bold text-blue-700">
        ...
        <div className="relative">
          <div className="p-8 bg-white border-t-4 shadow-2xl rounded-2xl md:p-12 border-emerald-500">
            ...
            <div className="absolute top-0 transform -translate-x-1/2 -translate-y-1/2 left-1/2">
              <div className="flex items-center justify-center w-16 h-16 rounded-full shadow-lg bg-emerald-500">
            ...
            <div className="mt-6 text-center">
              ...
              {/* Testimonial Text */}
              <blockquote className="max-w-4xl mx-auto mb-8 text-sm leading-relaxed lg:text-lg md:text-xl text-slate-700">
              ...
              <div className="pt-6 border-t">
                ...
                <p className="inline-block px-3 py-1 text-sm rounded-full text-slate-500 bg-slate-50">
